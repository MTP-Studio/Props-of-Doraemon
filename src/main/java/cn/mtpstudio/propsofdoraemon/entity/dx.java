...
public class dx<T extends EntityDx> extends EntityModel<T> {
	...
	public dx() {
		...
		headwear.texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.25F, false);
		...
		right_arm.texOffs(16, 40).addBox(-13.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		left_arm = new ModelRenderer(this);
		left_arm.setPos(-5.0F, 2.0F, 0.0F);
		bone.addChild(left_arm);
		left_arm.texOffs(32, 44).addBox(9.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		left_leg = new ModelRenderer(this);
		left_leg.setPos(-1.9F, 12.0F, 0.0F);
		bone.addChild(left_leg);
		left_leg.texOffs(32, 0).addBox(1.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		right_leg = new ModelRenderer(this);
		right_leg.setPos(1.9F, 12.0F, 0.0F);
		bone.addChild(right_leg);
		right_leg.texOffs(0, 32).addBox(-5.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
	}
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		this.headwear.yRot = netHeadYaw * 0.017453292F;
		this.headwear.xRot = headPitch * 0.017453292F;
	}
